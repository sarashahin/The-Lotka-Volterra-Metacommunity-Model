...
dir_list = [
    "/content/drive/MyDrive/Simulation_data/discrTraj_experiment/2021-3-1/1bMat0",
    "/content/drive/MyDrive/Simulation_data/betaDiscrTraj04_experiment/2021-3-1/1bMat0",
    "/content/drive/MyDrive/Simulation_data/normDiscrTraj04_experiment/2021-3-1/1bMat0"
]
...
if ANALYSE_DATA:
    ...
    dat.to_csv("/content/drive/MyDrive/Simulation_data/autonomous_turnover_example.csv", index=False)
else:
    dat = pd.read_csv("/content/drive/MyDrive/Simulation_data/autonomous_turnover_example.csv")
